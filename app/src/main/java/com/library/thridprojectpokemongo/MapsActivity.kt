package com.library.thridprojectpokemongo
...
import com.library.thridprojectpokemongo.R
...
class MapsActivity : FragmentActivity(), OnMapReadyCallback  {
    ...
    fun  LoadPockemon(){
        ...
        listPockemons.add(Pockemon(R.drawable.charmander,
            "Charmander", "Charmander living in japan", 55.0, 28.464370, 77.041265))
        listPockemons.add(Pockemon(R.drawable.bulbasaur,
            "Bulbasaur", "Bulbasaur living in usa", 90.5, 28.464360, 77.061250))
        listPockemons.add(Pockemon(
            R.drawable.squirtle,
            "Squirtle", "Squirtle living in iraq", 33.5, 28.464365, 77.091255))
